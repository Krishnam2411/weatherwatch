...
const showWeather = (data) => {
    ...
    weather.innerHTML = `
    <p>${data.main.temp}℃<br>${data.weather[0].main}<br>${data.main.temp_min}℃(min)  ${data.main.temp_max}℃(max)<br>Humidity : ${data.main.humidity}%<br>Pressure : ${data.main.pressure} mb<br>Wind speed : ${data.wind.speed} km/h<br>Visibility : ${data.visibility/1000} km</p>
    `
}
